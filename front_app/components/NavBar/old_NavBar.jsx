...
export default class NavBar extends Component {
  ...
  /* eslint-disable */
  activateMenu = () => {
    const elem = document.getElementById('navbar-menu')
    console.log('activateMenu', elem)
    console.log('activateMenu', elem.className)
    if (elem === undefined) {
      return
    }
    if (elem.className === 'navbar-menu') {
      elem.className = 'navbar-menu is-active'
    } else {
      elem.className = 'navbar-menu'
    }
      ...
      <div id='NavBarWrapper'>
        <nav className='navbar'>
          <div className='navbar-brand'>
            <a role='button' className='navbar-burger burger' aria-label='menu' aria-expanded='false' data-target='navbarBasicExample' onClick={this.activateMenu}>
